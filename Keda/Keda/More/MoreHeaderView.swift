...
protocol MoreHeaderViewDelegate: class {
...
class MoreHeaderView: UIView {
    ...
    //MARK: - Properties
    weak var delegate: MoreHeaderViewDelegate?
...
extension MoreHeaderView {
    ...
    func setupHeaderView(_ tableView: UITableView, dl: MoreHeaderViewDelegate, animDl: CAAnimationDelegate) {
