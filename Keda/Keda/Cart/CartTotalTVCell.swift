...
class CartTotalTVCell: UITableViewCell {
    
    //MARK: - Properties
    static let identifier = "CartTotalTVCell"
...
extension CartTotalTVCell {
    ...
    func configureCell() {
        ...
        //TODO: - NameLbl
        let totalNameTxt = NSLocalizedString("TOTAL", comment: "CartTotalTVCell.swift: TOTAL")
...
extension CartTotalTVCell {
    ...
    private func setupDarkModeView(_ isDarkMode: Bool = false) {
        ...
        totalTitleLbl.textColor = isDarkMode ? .white : .darkGray
