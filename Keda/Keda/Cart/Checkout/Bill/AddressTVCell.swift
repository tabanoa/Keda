...
extension AddressTVCell {
    ...
    func configureCell() {
        ...
        fullNameLbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        phoneNumberLbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        streetLine1Lbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        streetLine2Lbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        cityLbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        stateLbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        countryLbl.configureNameForCell(false, txtColor: .darkGray, fontSize: 16.0, isTxt: "", fontN: fontNamed)
        
        let views1 = [fullNameLbl, phoneNumberLbl, streetLine1Lbl, streetLine2Lbl, cityLbl, stateLbl, countryLbl]
...
extension AddressTVCell {
    ...
    private func setupDarkModeView(_ isDarkMode: Bool = false) {
        ...
        fullNameLbl.textColor = isDarkMode ? .lightGray : .darkGray
        phoneNumberLbl.textColor = isDarkMode ? .lightGray : .darkGray
        streetLine1Lbl.textColor = isDarkMode ? .lightGray : .darkGray
        streetLine2Lbl.textColor = isDarkMode ? .lightGray : .darkGray
        cityLbl.textColor = isDarkMode ? .lightGray : .darkGray
        stateLbl.textColor = isDarkMode ? .lightGray : .darkGray
        countryLbl.textColor = isDarkMode ? .lightGray : .darkGray
    }
}
