...
protocol CategoriesLoadIMGCVCellDelegate: class {
    func handleDeleteDidTap(_ cell: CategoriesLoadIMGCVCell)
}

class CategoriesLoadIMGCVCell: UICollectionViewCell {
    
    //MARK: - Properties
    static let identifier = "CategoriesLoadIMGCVCell"
    
    weak var delegate: CategoriesLoadIMGCVCellDelegate?
...
extension CategoriesLoadIMGCVCell {
