//
//  RecentlyViewedViewAllCVCell.swift
//  Keda
//
...
class RecentlyViewedViewAllCVCell: UICollectionViewCell {
    
    //MARK: - Properties
    static let identifier = "RecentlyViewedViewAllCVCell"
...
extension RecentlyViewedViewAllCVCell {
