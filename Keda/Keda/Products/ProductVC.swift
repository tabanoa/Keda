...
//        }
        //Send to chat
//        let vc = ChatViewController(with: user[0].uid)
//        vc.title = "Name"
...
//        navigationController?.pushViewController(vc, animated: true)
    ...
    //Goes to the messaging portion
//    private func goToMsg(completion: @escaping () -> Void){
//        if isLogIn(){
//            let conversationViewController = ConversationViewController()
//            conversationViewController.handleNewMessage()
//        }
//    }
    
    func successAlert() {
        let cTxt = NSLocalizedString("Item Added to Cart", comment: "ProductVC.swift: Item Added to Cart")
