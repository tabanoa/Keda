...
extension UIColor {
    ...
    func primary() -> UIColor {
        return UIColor(red: 30/255, green: 45/255, blue: 85/255, alpha: 1)
    }
    
    func tabBarUnselected() -> UIColor {
        return UIColor(red: 30/255, green: 216/255, blue: 223/255, alpha: 1)
    }
    
    static var sampleRed = UIColor(red: 30/255, green: 70/255, blue: 93/255, alpha: 1)
