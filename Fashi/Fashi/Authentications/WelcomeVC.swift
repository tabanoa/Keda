...
extension WelcomeVC {
    ...
    func updateUI() {
        ...
        //TODO: - Welcome Lbl
        let welcomeTxt = NSLocalizedString("Welcome To Fashi", comment: "WelcomeVC.swift: Welcome To Fashi")
        ...
        let titleTxt = NSLocalizedString("Shop and get updates on new products, promotions and sales with Fashi app.", comment: "WelcomeVC.swift: Title")
