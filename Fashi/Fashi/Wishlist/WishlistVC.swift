...
extension WishlistVC: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        touchAnim(cell.containerView, frValue: 0.8) {
            ...
            case categories[0]: products = Product.clothing(self.prCategories); break
            case categories[1]: products = Product.accessories(self.prCategories); break
            ...
            case categories[5]: products = Product.dresses(self.prCategories); break
            case categories[6]: products = Product.lingerie(self.prCategories); break
            case categories[7]: products = Product.men(self.prCategories); break
            case categories[8]: products = Product.kids(self.prCategories); break
            case categories[9]: products = Product.skirts(self.prCategories); break
            case categories[10]: products = Product.sleepwear(self.prCategories); break
            default: products = Product.swimwear(self.prCategories); break
            }
