//
//  ColorPickerGradientSlider.swift
//  Keda
//
...
class ColorPickerGradientSlider: UISlider {
...
extension ColorPickerGradientSlider {
    ...
    private func drawSlider() {
        ...
        sliderLayer.backgroundColor = UIColor.clear.cgColor
    ...
    private func initializeView() {
        ...
        let bundle = Bundle(for: ColorPickerGradientSlider.self)
