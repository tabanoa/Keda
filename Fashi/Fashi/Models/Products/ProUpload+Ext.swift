...
let accessoriesIMGLinks9: [String] = [
...
let accessoriesIMGLinks10: [String] = [
...
"""
        ...
        accessoriesIMGLinks9.forEach({ imgLinks1.append($0) })
        ...
        accessoriesIMGLinks10.forEach({ imgLinks2.append($0) })
        ...
        let tags: [String] = ["apple airpods", "airpods pro", "accessories", "headphone", "headphone bluetooth", "wireless headphones", "apple"]
