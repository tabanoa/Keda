...
extension Product {
    ...
    class func accessories1() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks1.forEach({ imgLinks.append($0) })
        ...
        let tags = ["diamond earrings", "accessories", "diamond swirl stud earrings"]
    ...
    class func accessories2() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks2.forEach({ imgLinks.append($0) })
        ...
        let tags = ["diamond earrings", "accessories", "pink pearl strand necklace", "pink ming pearl strand necklace"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories3() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks3.forEach({ imgLinks.append($0) })
        ...
        let tags = ["diamond earrings", "accessories", "teardrop drop earrings", "teardrop drop", "teardrop fringe drop earrings"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories4() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks4.forEach({ imgLinks.append($0) })
        ...
        let tags = ["diamond earrings", "accessories", "teardrop drop earrings", "teardrop drop", "blue diamond earrings", "swiss blue topaz, diamond earrings"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories5() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks5.forEach({ imgLinks.append($0) })
        ...
        let tags = ["lipstick", "accessories", "stay all day shimmer liquid lipstick"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories6() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks6.forEach({ imgLinks.append($0) })
        ...
        let tags = ["lipstick", "accessories", "liquid lip", "little twin stars liquid lip colour set"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories7() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks7.forEach({ imgLinks.append($0) })
        ...
        let tags = ["lipstick", "accessories", "liquid lip", "velour liquid lipstick holiday collection"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
    ...
    class func accessories8() -> Product {
...
"""
        ...
        var imgLinks: [String] = []
        accessoriesIMGLinks8.forEach({ imgLinks.append($0) })
        ...
        let tags = ["lipstick", "accessories", "liquid lip", "red mini bundle sets"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Accessories.rawValue,
