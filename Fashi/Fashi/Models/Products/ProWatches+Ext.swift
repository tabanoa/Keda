...
"""
        ...
        let tags = ["watches men", "watches women", "accessories", "apple watch", "watch", "bulova"]
...
"""
        ...
        let tags = ["watches men", "watches women", "accessories", "apple watch", "watch", "zeno"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Watches.rawValue,
...
"""
        ...
        let tags = ["watches men", "watches women", "accessories", "apple watch", "watch", "vulcain"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Watches.rawValue,
...
"""
        ...
        let tags = ["watches men", "watches women", "accessories", "apple watch", "watch", "apple watch 44mm", "apple watch 40mm", "apple watch pink", "apple watch white", "apple watch black", "apple watch series 5 gps, 40mm pink", "apple watch series 5 gps, 44mm pink", "apple watch series 5 gps, 40mm black", "apple watch series 5 gps, 44mm black", "apple watch series 5 gps, 40mm white", "apple watch series 5 gps, 44mm white"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Watches.rawValue,
