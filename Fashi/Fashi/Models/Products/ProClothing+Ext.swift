...
extension Product {
    ...
    class func clothing1() -> Product {
        let uid = "123456-CLOTHING-001"
...
"""
        ...
        let tags = ["overalls", "clothing", "shorts", "women", "skort", "lace up sides cheeky shorts"]
    ...
    class func clothing2() -> Product {
        let uid = "123456-CLOTHING-002"
...
"""
        ...
        let tags = ["overalls", "clothing", "shorts", "women", "skort", "refuge destroyed denim overalls"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Clothing.rawValue,
    ...
    class func clothing3() -> Product {
        let uid = "123456-CLOTHING-003"
...
"""
        ...
        let tags = ["overalls", "clothing", "shorts", "women", "skort", "front tie asymmetrical skort"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Clothing.rawValue,
    ...
    class func clothing4() -> Product {
        let uid = "123456-CLOTHING-004"
...
"""
        ...
        let tags = ["overalls", "clothing", "shorts", "women", "skort", "pleated scuba skater skirt"]
        let prModel = ProModel(uid: uid,
                               createdTime: createTime(),
                               prColors: prColors,
                               type: Categories.Clothing.rawValue,
