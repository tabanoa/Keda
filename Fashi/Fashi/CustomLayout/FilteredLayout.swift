//
//  FilteredLayout.swift
//  Keda
//
//  Created by Matthew Mukherjee on 03/03/2021.
import UIKit

protocol FilteredLayoutDelegate: class {
    func collectionView(heightForPhotoAt indexPath: IndexPath) -> CGFloat
}

class FilteredLayout: CustomLayout {
    
    weak var delegate: FilteredLayoutDelegate?
    ...
    override public func calculateCellFrame() {
        ...
        for section in 0..<sectionsCount {
            ...
            for item in 0..<itemsCount {
                ...
                contentSize.height = max(contentSize.height+(height/2.5), frame.maxY)
