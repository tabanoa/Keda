...
public let defaultColor = UIColor(hex: 0xFFBA14)
...
public var categories: [String] = [
    NSLocalizedString("Clothing", comment: "Types.swift: Clothing"),        //0
    NSLocalizedString("Accessories", comment: "Types.swift: Accessories"),  //1
    ...
    NSLocalizedString("Dresses", comment: "Types.swift: Dresses"),          //5
    NSLocalizedString("Lingerie", comment: "Types.swift: Lingerie"),        //6
    NSLocalizedString("Men", comment: "Types.swift: Men"),                  //7
    NSLocalizedString("Kids", comment: "Types.swift: Kids"),                //8
    NSLocalizedString("Skirts", comment: "Types.swift: Skirts"),            //9
    NSLocalizedString("Sleepwear", comment: "Types.swift: Sleepwear"),      //10
    NSLocalizedString("Swimwear", comment: "Types.swift: Swimwear")         //11
]
