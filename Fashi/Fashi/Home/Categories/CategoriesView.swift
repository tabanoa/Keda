...
extension CategoriesView: UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        touchAnim(cell, frValue: 0.8) {
            ...
            case categories[0]: products = Product.clothing(self.homeVC.allProducts); break
            case categories[1]: products = Product.accessories(self.homeVC.allProducts); break
            ...
            case categories[5]: products = Product.dresses(self.homeVC.allProducts); break
            case categories[6]: products = Product.lingerie(self.homeVC.allProducts); break
            case categories[7]: products = Product.men(self.homeVC.allProducts); break
            case categories[8]: products = Product.kids(self.homeVC.allProducts); break
            case categories[9]: products = Product.skirts(self.homeVC.allProducts); break
            case categories[10]: products = Product.sleepwear(self.homeVC.allProducts); break
            default: products = Product.swimwear(self.homeVC.allProducts); break
            }
