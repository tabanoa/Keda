...
extension HomeContainerView {
    ...
    func setuContacts() {
        ...
        setupContactBtn(fbBtn, selector: #selector(fbDidTap), title: "FashiFlow")
        
        setupContactImg(iconTW, imgName: "icon-tw")
        setupContactBtn(twBtn, selector: #selector(twDidTap), title: "@FashiFlow")
...
extension HomeContainerView {
    ...
    func darkModeContactBtn(_ isDarkMode: Bool = false) {
        ...
        setupDMContactBtn(fbBtn, txtC: tintColor, title: "FashiFlow")
        setupDMContactBtn(twBtn, txtC: tintColor, title: "@FashiFlow")
